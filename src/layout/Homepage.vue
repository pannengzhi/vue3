<template>
	<div>
		<div class="page-container">
			<el-carousel :interval="5000" type="card" height="450px" class="carousel">
				<el-carousel-item class="carousel-item-intro">
					...
					<div><img src="@/assets/logo.png" style="height:120px;padding-top:15px;" /></div>
				</el-carousel-item>
		...
		<div class="footer">© 2019 spepc Apache License 2.0 ⋅ 浙ICP备18005431号-3</div>
	</div>
</template>
